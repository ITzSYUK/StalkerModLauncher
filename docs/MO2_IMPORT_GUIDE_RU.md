...
Мастер переноса создаёт новый профиль S.T.A.L.K.E.R. Mod Launcher из уже настроенного профиля MO2. Папки игры, модов и `overwrite` остаются на месте: лаунчер использует их только как источники.
...
Нажмите кнопку **MO2** рядом со списком профилей.
...
4. При необходимости отдельно проверьте запуск через **USVFS**.
...
![Обозначения конфликтов модов](assets/screenshots/conflict-icon-legend-ru.png)

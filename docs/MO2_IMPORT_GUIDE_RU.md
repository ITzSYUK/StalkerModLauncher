...
Мастер переноса создаёт новый профиль CORDON из уже настроенного профиля MO2. Папки игры, модов и `overwrite` остаются на месте: лаунчер использует их только как источники.
